...
function Aboutcenter() {
  return (
      <div className='w-full h-screen  items-center flex flex-col self-center' >
          <h1 className='capitalize text-center text-5xl mt-8 font-bold text-transparent bg-clip-text  bg-gradient-to-r from-[#740287] to-[#020887] mb-10'>our objectives</h1>
