...
<<<<<<< HEAD
          <h1 className='capitalize text-center text-5xl mt-8 font-bold text-transparent bg-clip-text p-2 bg-gradient-to-r from-[#740287] to-[#020887] mb-10'> about us</h1>
          <div className='w-[85%]  self-center h-80  px-24 flex gap-5 items-center'>
            <img src={firstImage} alt="firstaboutimage" className='object-contain w-[316px] h-[216px]'/>
            <img src={secondImage} alt="secondaboutimage" className='object-contain w-[316px] h-[216px]'/>
            <img src={thirdImage} alt="thirdaboutimage" className='object-contain w-[316px] h-[216px]'/>
=======
          ...
          <div className='w-[85%] min-w-[765px]  self-center h-80  px-24 flex gap-5 items-center'>
            <img src={firstImage} alt="first " className='object-contain w-[40%] min-w-[28%] h-[216px]'/>
            <img src={secondImage} alt=" second" className='object-contain w-[40%] min-w-[28%] h-[216px]'/>
            <img src={thirdImage} alt="third" className='object-contain w-[40%] h-[216px] min-w-[28%]'/>
>>>>>>> ddcbffa5250c97072dbe3704ca18382c7f611aff
          </div>
          <div className='w-[90%] self-center h-80 text-center px-20 flex gap-5 items-center'>
